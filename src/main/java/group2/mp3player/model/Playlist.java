 ...
 * The playlist has a name and provides various methods to manage its songs.
 *
...
public class Playlist<PlayList> {
    ...
    /**
     * Sets the list of songs in the playlist to the provided list, replacing any existing songs.
     *
